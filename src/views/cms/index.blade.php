    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="card user-wrapper">
                {!! Form::open(['route' => 'cms.create.home', 'method' => 'post', 'files' => true, 'id'=>'create-cms']) !!}
                @csrf
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">{{trans('tran::views.cms')}}</h5>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label class="font-weight-semibold text-default">Banner Image</label>
                            <div class="image-upload customBrowse ">
                                {{ Form::file('banner_image', ['class'=> 'file-input-ajax ', 'accept'=>'image/x-png,image/jpg,image/jpeg']) }}
