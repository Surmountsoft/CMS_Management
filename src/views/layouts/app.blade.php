...
<!--    <script src="{{asset('assets/admin/global_assets/js/plugins/visualization/d3/d3.min.js')}}"></script>
    ...
    <script src="{{asset('assets/admin/global_assets/js/plugins/notifications/bootbox.min.js')}}"></script>
      <script src="{{asset('assets/admin/global_assets/js/plugins/uploaders/fileinput/fileinput.min.js')}}"></script>
    <script src="{{asset('assets/admin/global_assets/js/plugins/uploaders/fileinput/plugins/purify.min.js')}}"></script>
    <script src="{{asset('assets/admin/global_assets/js/plugins/uploaders/fileinput/plugins/sortable.min.js')}}"></script>
    <script src="{{asset('assets/admin/global_assets/js/demo_pages/uploader_bootstrap.js')}}"></script>
    <!-- Laravel Javascript Validation -->
    <script type="text/javascript" src="{{ asset('js/jsvalidation/js/jsvalidation.js')}}"></script>
    <script src="{{asset('assets/admin/global_assets/js/plugins/ckeditor/ckeditor.js')}}"></script>
